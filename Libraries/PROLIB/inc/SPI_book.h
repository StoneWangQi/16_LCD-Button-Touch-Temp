...
#define  FLASH_SPI_PowerDown			        0xB9 
#define  FLASH_SPI_ReleasePowerDown	    0xAB 
...
void SPI_BufferRead_Data(uint8_t *writeBuffer , uint32_t WriteAddr ,uint32_t  numByteToWrite );
void SPI_Write_Data(uint8_t *writeBuffer , uint32_t addr ,uint32_t  numByteToRead );
void SPI_BufferWrite_Data(uint8_t *writeBuffer , uint32_t WriteAddr ,uint32_t  numByteToWrite );
